...
jQuery.event = {
	...
	special: {
		load: {
			...
			// Prevent triggered currentImage.load events from bubbling to window.load
			noBubble: true
		},
		click: {
...
// for the currentDescription of the bug (it existed in older Chrome versions as well).
jQuery.each( {
